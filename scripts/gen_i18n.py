...
EN = {
    ...
    "meta_desc": "tautiu (透抽) is Taiwanese for squid. One little squid, eight busy tentacles — indie Mac & iPhone apps: DeepSRT, DeepSRT Transcribe, Foldic, Recilic, Ripplic, Mergic, Nookic, Lossic.",
    "og_title": "tautiu — a tiny indie app studio",
    "og_desc": "One little squid, eight busy tentacles. Indie Mac & iPhone apps made with care.",
    "tagline": "a tiny indie app studio",
    "story": """<span class="zh">tautiu（透抽）</span> is Taiwanese for squid —
    one little squid, eight busy tentacles, each holding an app
...
LANGS = {
    "zh": {
        ...
        "meta_desc": "tautiu（透抽）是台語的魷魚。一隻小透抽、八隻忙碌的觸手 — 獨立開發的 Mac 與 iPhone App：DeepSRT、DeepSRT Transcribe、Foldic、Recilic、Ripplic、Mergic、Nookic、Lossic。",
        "og_title": "tautiu — 小小的獨立 App 工作室",
        "og_desc": "一隻小透抽、八隻忙碌的觸手。用心打造的獨立 Mac 與 iPhone App。",
    ...
    "ja": {
        ...
        "meta_desc": "tautiu（透抽）は台湾語でイカのこと。小さなイカと八本の忙しい腕 — Mac と iPhone のためのインディーアプリ：DeepSRT、DeepSRT Transcribe、Foldic、Recilic、Ripplic、Mergic、Nookic、Lossic。",
        "og_title": "tautiu — 小さなインディーアプリスタジオ",
        "og_desc": "小さなイカと八本の忙しい腕。心を込めてつくった Mac と iPhone のアプリ。",
    ...
    "ko": {
        ...
        "meta_desc": "tautiu(透抽)는 대만어로 오징어. 작은 오징어와 여덟 개의 바쁜 다리 — Mac과 iPhone을 위한 인디 앱: DeepSRT, DeepSRT Transcribe, Foldic, Recilic, Ripplic, Mergic, Nookic, Lossic.",
        "og_title": "tautiu — 작은 인디 앱 스튜디오",
        "og_desc": "작은 오징어와 여덟 개의 바쁜 다리. 정성껏 만든 Mac & iPhone 앱.",
        "tagline": "작은 인디 앱 스튜디오",
        "story": """<span class="zh">tautiu（透抽）</span>는 대만어로 오징어 —
    작은 오징어 한 마리가 여덟 개의 바쁜 다리로,
...
for code, t in LANGS.items():
    ...
    for key in ("tagline", "story", "deepsrt_transcribe", "deepsrt", "foldic", "recilic",
                "ripplic", "mergic", "nookic", "lossic", "ribbon_internal", "ribbon", "footer"):
