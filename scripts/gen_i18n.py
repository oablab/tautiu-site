...
EN = {
    ...
    "deepsrt_transcribe": "Transcription runs on Apple's on-device speech models, so nothing has to be uploaded — then refined by Gemini and auto-corrected with Google Search grounding.",
...
LANGS = {
    ...
    忙著為你的 Mac 和 iPhone 打造 App。""",
        ...
        "deepsrt_transcribe": "Apple 語音模型在你的 Mac 上運算，影像和聲音都能離線處理 — 再由最強 Gemini 模型優化語言，Grounding with Google Search 自動校正。",
    ...
    Mac と iPhone のためのアプリをつくっています。""",
        ...
        "deepsrt_transcribe": "Apple の音声モデルはお使いの Mac 上で処理。映像も音声もアップロードは不要。さらに最強の Gemini が言語を最適化し、Google 検索グラウンディングで自動補正。",
    ...
    Mac과 iPhone을 위한 앱을 만들고 있어요.""",
        ...
        "deepsrt_transcribe": "Apple 음성 모델을 기기에서 처리하므로 영상과 음성을 업로드할 필요가 없습니다. 최강 Gemini 모델의 언어 최적화와 Google 검색 그라운딩으로 자동 교정까지.",
